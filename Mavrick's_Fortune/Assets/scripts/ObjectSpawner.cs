...
public class ObjectSpawner : MonoBehaviour
{
    ...
    private void SpawnObject()
    {
        if (objectsToSpawn.Length > 0)
        {
            ...
            GameObject obj = Instantiate(objectsToSpawn[randomIndex], transform.position, Quaternion.identity);
            // You might want to set the parent of the spawned object or modify its properties here.
        }
    }
